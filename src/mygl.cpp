...
void MyGL::resizeGL(int w, int h)
{
    ...
    mp_progSurfaceCurrent->setEyePos(glm::vec4(m_camera.eye, 1.f));//new
...
void MyGL::createShaders()
{
    ...
    std::shared_ptr<SurfaceShader> toonShader = std::make_shared<SurfaceShader>(this);
    toonShader->create(":/glsl/surface/toonShader.vert.glsl", ":/glsl/surface/toonShader.frag.glsl");
    m_surfaceShaders.push_back(toonShader);
